...
public class BlockLiquidDrillComponent extends Block
{
    public BlockLiquidDrillComponent()
    {
        super(Material.IRON);
        this.setRegistryName(F0RRegistryNames.asLocation(F0RRegistryNames.liquidDrillComponent));
    ...
    public void onBlockPlacedBy(World worldIn, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack)
    {
        ...
        if (center != BlockPos.ORIGIN)
        {
            ...
            for (int dx = -1; dx <= 1; ++dx)
            {
                ...
                {
                    BlockPos at = center.add(dx, 0, dz);
                    worldIn.setBlockState(at, F0RBlocks.liquidDrillPart.getDefaultState());
                    TileLiquidDrill tile = (TileLiquidDrill) worldIn.getTileEntity(at);
    ...
    {
        return world.getBlockState(pos).getBlock() == F0RBlocks.liquidDrillComponent;
    }
}
